...
#                'gold_coords': [coord for coord in state['gold_coords']]
#                }
#            for next_agent_coord in next_agent_coords
#            ]
#            
#            if env.stair_coord in next_agent_coords and env.stair_coord in state['gold_coords']:
...
def online_greedy_search(env: MiniHackGoldRoom, value_function1: Callable[dict, float] = None, value_function2: Callable[dict, float] = None, conditions: Callable[Tuple[dict, List[dict]], bool] = None, max_steps: int = 1000):
